...
if (suppressWarnings(!require(lmtest))) {install.packages("lmtest"); library(lmtest)}
...
# You can also create your own customized diagnostic plots using ggplot2
ggplot(data = model$residuals, aes(x = fitted(model), y = .)) +
  geom_point() +
  geom_smooth()
