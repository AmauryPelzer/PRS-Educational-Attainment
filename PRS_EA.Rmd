...
Sum scores (range 0-30). There is no established cut-off score for IADL impairment on the FAQ. A higher score relates to more severe impairment in functional abilities.

```{r, echo=FALSE, message=FALSE}
cvalue$FAQ <- calculate_cvalue(FAQ)
...
```{r, echo=FALSE, message=FALSE}
cvalue$LDELTOTAL <- calculate_cvalue(LDELTOTAL)
...
```{r, echo=FALSE, message=FALSE}
cvalue$RAVLT_immediate <- calculate_cvalue(RAVLT_immediate)
