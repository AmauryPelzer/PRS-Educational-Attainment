...
surv_fit <- survfit(Surv(as.integer(VISCODE), MMSE_cut) ~ thirtile, data = long_dat)
...
legend("topright", legend = c("under-performed", "middle", "over-performed"), col = c("blue", "green", "red"), lwd = 2)

# Log Rank Test 
logrank_test <- list()
logrank_test$MMSE <- survdiff(Surv(as.integer(VISCODE), MMSE_cut) ~ thirtile, data = long_dat)
print(c("Log Rank Test p-value:", logrank_test$MMSE$pvalue))
...
# Fit the Kaplan-Meier estimator
surv_fit <- survfit(Surv(as.integer(VISCODE), ADAS11_cut) ~ thirtile, data = long_dat)
...
# Log Rank Test 
logrank_test$ADAS11 <- survdiff(Surv(as.integer(VISCODE), ADAS11_cut) ~ thirtile, data = long_dat)
print(c("Log Rank Test p-value:", logrank_test$ADAS11$pvalue))
...
# Fit the Kaplan-Meier estimator
surv_fit <- survfit(Surv(as.integer(VISCODE), ADAS13_cut) ~ thirtile, data = long_dat)
...
# Log Rank Test 
logrank_test$ADAS13 <- survdiff(Surv(as.integer(VISCODE), ADAS13_cut) ~ thirtile, data = long_dat)
print(c("Log Rank Test p-value:", logrank_test$ADAS13$pvalue))
...
# Fit the Kaplan-Meier estimator
surv_fit <- survfit(Surv(as.integer(VISCODE), ADASQ4_cut) ~ thirtile, data = long_dat)
...
# Log Rank Test 
logrank_test$ADASQ4 <- survdiff(Surv(as.integer(VISCODE), ADASQ4_cut) ~ thirtile, data = long_dat)
print(c("Log Rank Test p-value:", logrank_test$ADASQ4$pvalue))
...
# Fit the Kaplan-Meier estimator
surv_fit <- survfit(Surv(as.integer(VISCODE), CDRSB_cut) ~ thirtile, data = long_dat)
...
# Log Rank Test 
logrank_test$CDRSB <- survdiff(Surv(as.integer(VISCODE), CDRSB_cut) ~ thirtile, data = long_dat)
print(c("Log Rank Test p-value:", logrank_test$CDRSB$pvalue))
...
# Fit the Kaplan-Meier estimator
surv_fit <- survfit(Surv(as.integer(VISCODE), DIGITSCOR_cut) ~ thirtile, data = long_dat)
...
# Log Rank Test 
logrank_test$DIGITSCOR <- survdiff(Surv(as.integer(VISCODE), DIGITSCOR_cut) ~ thirtile, data = long_dat)
print(c("Log Rank Test p-value:", logrank_test$DIGITSCOR$pvalue))
...
# Fit the Kaplan-Meier estimator
surv_fit <- survfit(Surv(as.integer(VISCODE), EcogPtDivatt_cut) ~ thirtile, data = long_dat)
...
# Log Rank Test 
logrank_test$EcogPtDivatt <- survdiff(Surv(as.integer(VISCODE), EcogPtDivatt_cut) ~ thirtile, data = long_dat)
print(c("Log Rank Test p-value:", logrank_test$EcogPtDivatt$pvalue))
...
# Fit the Kaplan-Meier estimator
surv_fit <- survfit(Surv(as.integer(VISCODE), EcogSPVisspat_cut) ~ thirtile, data = long_dat)
...
# Log Rank Test 
logrank_test$EcogSPVisspat <- survdiff(Surv(as.integer(VISCODE), EcogSPVisspat_cut) ~ thirtile, data = long_dat)
print(c("Log Rank Test p-value:", logrank_test$EcogSPVisspat$pvalue))
...
# Fit the Kaplan-Meier estimator
surv_fit <- survfit(Surv(as.integer(VISCODE), FAQ_cut) ~ thirtile, data = long_dat)
...
# Log Rank Test 
logrank_test$FAQ <- survdiff(Surv(as.integer(VISCODE), FAQ_cut) ~ thirtile, data = long_dat)
print(c("Log Rank Test p-value:", logrank_test$FAQ$pvalue))
...
# Fit the Kaplan-Meier estimator
surv_fit <- survfit(Surv(as.integer(VISCODE), LDELTOTAL_cut) ~ thirtile, data = long_dat)
...
# Log Rank Test 
logrank_test$LDELTOTAL <- survdiff(Surv(as.integer(VISCODE), LDELTOTAL_cut) ~ thirtile, data = long_dat)
print(c("Log Rank Test p-value:", logrank_test$LDELTOTAL$pvalue))
...
# Fit the Kaplan-Meier estimator
surv_fit <- survfit(Surv(as.integer(VISCODE), MOCA_cut) ~ thirtile, data = long_dat)
...
# Log Rank Test 
logrank_test$MOCA <- survdiff(Surv(as.integer(VISCODE), MOCA_cut) ~ thirtile, data = long_dat)
print(c("Log Rank Test p-value:", logrank_test$MOCA$pvalue))
...
# Fit the Kaplan-Meier estimator
surv_fit <- survfit(Surv(as.integer(VISCODE), RAVLT_forgetting_cut) ~ thirtile, data = long_dat)
...
# Log Rank Test 
logrank_test$RAVLT_forgetting <- survdiff(Surv(as.integer(VISCODE), RAVLT_forgetting_cut) ~ thirtile, data = long_dat)
print(c("Log Rank Test p-value:", logrank_test$RAVLT_forgetting$pvalue))
...
# Fit the Kaplan-Meier estimator
surv_fit <- survfit(Surv(as.integer(VISCODE), RAVLT_immediate_cut) ~ thirtile, data = long_dat)
...
# Log Rank Test 
logrank_test$RAVLT_immediate <- survdiff(Surv(as.integer(VISCODE), RAVLT_immediate_cut) ~ thirtile, data = long_dat)
print(c("Log Rank Test p-value:", logrank_test$RAVLT_immediate$pvalue))
...
# Fit the Kaplan-Meier estimator
surv_fit <- survfit(Surv(as.integer(VISCODE), RAVLT_learning_cut) ~ thirtile, data = long_dat)
...
# Log Rank Test 
logrank_test$RAVLT_learning <- survdiff(Surv(as.integer(VISCODE), RAVLT_learning_cut) ~ thirtile, data = long_dat)
print(c("Log Rank Test p-value:", logrank_test$RAVLT_learning$pvalue))
...
# Fit the Kaplan-Meier estimator
surv_fit <- survfit(Surv(as.integer(VISCODE), TRABSCOR_cut) ~ thirtile, data = long_dat)
...
# Log Rank Test 
logrank_test$TRABSCOR <- survdiff(Surv(as.integer(VISCODE), TRABSCOR_cut) ~ thirtile, data = long_dat)
print(c("Log Rank Test p-value:", logrank_test$TRABSCOR$pvalue))
...
# Fit the Kaplan-Meier estimator
surv_fit <- survfit(Surv(as.integer(VISCODE), EcogPtLang_cut) ~ thirtile, data = long_dat)
...
# Log Rank Test 
logrank_test$EcogPtLang <- survdiff(Surv(as.integer(VISCODE), EcogPtLang_cut) ~ thirtile, data = long_dat)
print(c("Log Rank Test p-value:", logrank_test$EcogPtLang$pvalue))
...
# Fit the Kaplan-Meier estimator
surv_fit <- survfit(Surv(as.integer(VISCODE), EcogPtMem_cut) ~ thirtile, data = long_dat)
...
# Log Rank Test 
logrank_test$EcogPtMem <- survdiff(Surv(as.integer(VISCODE), EcogPtMem_cut) ~ thirtile, data = long_dat)
print(c("Log Rank Test p-value:", logrank_test$EcogPtMem$pvalue))
...
# Fit the Kaplan-Meier estimator
surv_fit <- survfit(Surv(as.integer(VISCODE), EcogPtOrgan_cut) ~ thirtile, data = long_dat)
...
# Log Rank Test 
logrank_test$EcogPtOrgan <- survdiff(Surv(as.integer(VISCODE), EcogPtOrgan_cut) ~ thirtile, data = long_dat)
print(c("Log Rank Test p-value:", logrank_test$EcogPtOrgan$pvalue))
...
# Fit the Kaplan-Meier estimator
surv_fit <- survfit(Surv(as.integer(VISCODE), EcogPtPlan_cut) ~ thirtile, data = long_dat)
...
# Log Rank Test 
logrank_test$EcogPtPlan <- survdiff(Surv(as.integer(VISCODE), EcogPtPlan_cut) ~ thirtile, data = long_dat)
print(c("Log Rank Test p-value:", logrank_test$EcogPtPlan$pvalue))
...
# Fit the Kaplan-Meier estimator
surv_fit <- survfit(Surv(as.integer(VISCODE), EcogPtTotal_cut) ~ thirtile, data = long_dat)
...
# Log Rank Test 
logrank_test$EcogPtTotal <- survdiff(Surv(as.integer(VISCODE), EcogPtTotal_cut) ~ thirtile, data = long_dat)
print(c("Log Rank Test p-value:", logrank_test$EcogPtTotal$pvalue))
...
# Fit the Kaplan-Meier estimator
surv_fit <- survfit(Surv(as.integer(VISCODE), EcogPtVisspat_cut) ~ thirtile, data = long_dat)
...
# Log Rank Test 
logrank_test$EcogPtVisspat <- survdiff(Surv(as.integer(VISCODE), EcogPtVisspat_cut) ~ thirtile, data = long_dat)
print(c("Log Rank Test p-value:", logrank_test$EcogPtVisspat$pvalue))
...
# Fit the Kaplan-Meier estimator
surv_fit <- survfit(Surv(as.integer(VISCODE), EcogSPDivatt_cut) ~ thirtile, data = long_dat)
...
# Log Rank Test 
logrank_test$EcogSPDivatt <- survdiff(Surv(as.integer(VISCODE), EcogSPDivatt_cut) ~ thirtile, data = long_dat)
print(c("Log Rank Test p-value:", logrank_test$EcogSPDivatt$pvalue))
...
# Fit the Kaplan-Meier estimator
surv_fit <- survfit(Surv(as.integer(VISCODE), EcogSPLang_cut) ~ thirtile, data = long_dat)
...
# Log Rank Test 
logrank_test$EcogSPLang <- survdiff(Surv(as.integer(VISCODE), EcogSPLang_cut) ~ thirtile, data = long_dat)
print(c("Log Rank Test p-value:", logrank_test$EcogSPLang$pvalue))
...
# Fit the Kaplan-Meier estimator
surv_fit <- survfit(Surv(as.integer(VISCODE), EcogSPMem_cut) ~ thirtile, data = long_dat)
...
# Log Rank Test 
logrank_test$EcogSPMem <- survdiff(Surv(as.integer(VISCODE), EcogSPMem_cut) ~ thirtile, data = long_dat)
print(c("Log Rank Test p-value:", logrank_test$EcogSPMem$pvalue))
...
# Fit the Kaplan-Meier estimator
surv_fit <- survfit(Surv(as.integer(VISCODE), EcogSPOrgan_cut) ~ thirtile, data = long_dat)
...
# Log Rank Test 
logrank_test$EcogSPOrgan <- survdiff(Surv(as.integer(VISCODE), EcogSPOrgan_cut) ~ thirtile, data = long_dat)
print(c("Log Rank Test p-value:", logrank_test$EcogSPOrgan$pvalue))
...
# Fit the Kaplan-Meier estimator
surv_fit <- survfit(Surv(as.integer(VISCODE), EcogSPPlan_cut) ~ thirtile, data = long_dat)
...
# Log Rank Test 
logrank_test$EcogSPPlan <- survdiff(Surv(as.integer(VISCODE), EcogSPPlan_cut) ~ thirtile, data = long_dat)
print(c("Log Rank Test p-value:", logrank_test$EcogSPPlan$pvalue))
...
# Fit the Kaplan-Meier estimator
surv_fit <- survfit(Surv(as.integer(VISCODE), EcogSPTotal_cut) ~ thirtile, data = long_dat)
...
# Log Rank Test 
logrank_test$EcogSPTotal <- survdiff(Surv(as.integer(VISCODE), EcogSPTotal_cut) ~ thirtile, data = long_dat)
print(c("Log Rank Test p-value:", logrank_test$EcogSPTotal$pvalue))
