...
plot_coxph <- function(coxph_model){
  ...
  ggsurvplot(
    ...
    title = "Survival Curve (MMSE_cut ~ PGS + AGE + GENDER + AGExGENDER)", # Need to change title
    xlab = "Time",
...
# Creates Cox Proportional Hazards regression model
res.cox <- fit_coxph("ADASQ4_cut", cox_filtered_dat)
...
```{r}
# Tests model assumptions
test_coxph(res.cox, "ADASQ4_cut", cox_filtered_dat)
